...
jQuery( document ).ready(function() {
  ...
  function card() {
     ...
     $("#makeMeDraggable1").data('img', "me").appendTo('#makeMeDraggable1').draggable();
     $("#makeMeDraggable2").data('img', "me").appendTo('#makeMeDraggable2').draggable();
     $("#makeMeDraggable3").data('img', "me").appendTo('#makeMeDraggable3').draggable();
  ...
  function slot() {
    $("#makeMeDroppable").droppable({
      ...
      drop: function( event, ui ) {
       ...
       var droppermanent=ui.draggable.data('img');  
  ...
  window.onscroll = function(ev) {
    if ((window.innerHeight + window.scrollY) >= document.body.offsetHeight && counter < session.length ) {
       ...
       jQuery("#nomore").text("© 2024 Lasindu Software. All Rights Reserved");
    }
});